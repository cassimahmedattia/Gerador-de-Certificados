...
class Certificate_Generator ():
    ...
    def generate_certificate (self, certificate_name, file_name): 
        ...
        certificate_font       = ImageFont.truetype("Forum-Regular.ttf", 170, encoding="unic")
        certificate_image_draw.text((650,1100), certificate_name, font=certificate_font, fill=(0,0,0))
